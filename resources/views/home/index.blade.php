...
<div class="container-fluid" style="padding-left: 0px;padding-right: 0px;">
	<div class="search-map hidden-xs" >
		<div id="map" class="bgr"> <img src="images/bgr.jpg" width="1519px" height="500px" alt=""></div>
				...
				<!-- <div class="email-box">
					...
					<div class="row room-hot">
						...
						<div class="col-md-4 col-sm-6">
							...
							<div class="container">
								<h3 class="title-comm"><span class="title-holder">PHÒNG TRỌ THÀNH PHỐ VINH</span></h3>
								<div class="row">
									<div class="col-md-8">
							...
							<script>
								...
								function initMap() {
									map = new google.maps.Map(document.getElementById('map'), {
										center: {lat: 18.679585, lng: 105.681335},
										zoom: 15,
										draggable: true
									});
